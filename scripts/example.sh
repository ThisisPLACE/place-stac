...
python place/place_image/cli_single.py \
...
python place/place_image/cli_single.py \
    ...
    --output output/aerial/DSC01173-example-rotation.tif \
    --latitude 5.359087 \
    --longitude -4.024535 \
    --altitude 177.28571428571428 \
    --rotation-matrix -0.7911203503516162 -0.6096267883930258 -0.0498374370643293 0.6115911559767407 -0.7896275502534962 -0.0494427933241718 -0.0092113620366244 -0.0695953357220725 0.9975327764315127

python place/place_image/cli_multiple.py \
